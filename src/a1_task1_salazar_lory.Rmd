...
ggplot(data = frog_count, aes(x = year, y = n)) +
  ...
  labs(title = "Mountain yellow-legged frog counts by life stage (1997-2002)",
...
ggplot(data = adult_yellow_ct, aes(x = reorder(lake_id, -n), y = n)) +
  geom_col() +
  labs(title = "Top five whatever",
